...
1.1. **Наименование проекта**: «[methodology.city](https://methodology.city)» (далее – «Проект»).  
1.2. **Форма**: Проект может функционировать в любой организационно-правовой форме (НКО, ассоциация, товарищество, ООО и т.д.).  
1.3. **Территория реализации**: Черногория.  
1.4. **Срок действия**: Проект создаётся на неопределённый срок.  
1.5. **Язык**: Основной язык документации – русский. При необходимости используются черногорский, английский или другие языки.  
